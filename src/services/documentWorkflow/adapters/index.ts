import { isNewTab, isPreviewPath } from '../../../utils/fileTypes.ts'
import { markdownDocumentAdapter } from './markdown.ts'
import { latexDocumentAdapter } from './latex.ts'
import { pythonDocumentAdapter } from './python.ts'
