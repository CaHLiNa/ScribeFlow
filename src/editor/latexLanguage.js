...
const TEXTMATE_SCOPE_CLASSIFIERS = Object.freeze([
  ...
  ['storage.type.function', 'cm-tm-support-function'],
  ['storage.type', 'cm-tm-support-function'],
  ['keyword.other.item', 'cm-tm-keyword-control'],
  ['keyword.other', 'cm-tm-keyword-control'],
