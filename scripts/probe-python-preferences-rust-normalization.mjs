...
try {
  ...
  assert.deepEqual(
    ...
    ['python_preferences_normalize', 'python_preferences_save'],
  )
  assert.equal(calls[1].args.params.preferences.interpreterPreference, '/opt/homebrew/bin/python3')
  ...
  assert.equal(calls[3].args.params.preferences.interpreterPreference, 'auto')
