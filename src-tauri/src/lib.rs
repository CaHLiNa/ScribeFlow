...
pub fn run() {
    ...
    builder
        .invoke_handler(tauri::generate_handler![
            ...
            document_workflow_ui_state::document_workflow_context_resolve,
            ...
            editor_session_runtime::editor_recent_files_record_opened,
            editor_session_runtime::editor_recent_files_rename_path,
