...
- extension task presentation is now shared too: right-sidebar task rows derive title, status tone, progress copy, progressbar metadata, target facts, result counts and artifact counts from one pure presentation helper instead of duplicating running/recent UI branches
