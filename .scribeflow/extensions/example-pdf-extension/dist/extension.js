export async function activate(context) {
    ...
    function buildSidebarSections(overrides = {}) {
        ...
        const targetLang = String(overrides.targetLang ||
    ...
    context.capabilities.registerProvider("pdf.translate", async (request) => {
        ...
        const configuredTargetLang = String(context.settings.get("examplePdfExtension.targetLang", "zh-CN") || "zh-CN");
    ...
    context.commands.registerCommand("examplePdfExtension.inspectPdfApi", async () => {
        const pdf = currentPdf();
        const candidatePdfPath = String(pdf.path ||
