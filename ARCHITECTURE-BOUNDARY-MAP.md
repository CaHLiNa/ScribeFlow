...
| `src/components/references/ReferenceLibraryWorkbench.vue` | 666 | Reference workbench orchestration; main-list/detail-dock presentation, deterministic workbench helpers, and context-menu presentation groups now live outside the coordinator. |
