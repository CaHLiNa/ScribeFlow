...
| `src/components/extensions/ExtensionTaskPanel.vue` | 697 | Extension task timeline, row detail, result preview and task action surface; next split candidate after task presentation contracts settle. |
