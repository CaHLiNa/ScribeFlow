...
| `src/components/references/ReferenceLibraryWorkbench.vue` | 713 | Reference workbench orchestration; toolbar/table/detail-dock presentation, deterministic workbench helpers, and context-menu presentation groups now live outside the coordinator. |
